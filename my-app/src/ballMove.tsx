...
import {lastPossitionOfRightRectY as gLastPossitionOfRightRectY} from './mySketch'; 
import {lastPossitionOfLeftRectY as gLastPossitionOfLeftRectY} from './mySketch'; 
...
let ballMove =  (p5 : p5Types) : void =>
{
    ...
    let lastPossitionOfRightRectY : number | undefined = gLastPossitionOfRightRectY;
    let lastPossitionOfLeftRectY : number | undefined = gLastPossitionOfLeftRectY;
